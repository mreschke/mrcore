...
use Mrcore\Models\Router as RouterTable;
use Request;
use Config;

/*

BIG problem nere, we inrementClick without knowing permissions
unless redirecting to external url, I need to incrementClicks later
in the chain, elsewhere
